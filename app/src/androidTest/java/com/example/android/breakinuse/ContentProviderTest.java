...
public class ContentProviderTest extends AndroidTestCase {
    ...
    public void testContentProviderQuery(){
        ...
        Uri uri = contentResolver.insert(NewsContract.NewsFeed.CONTENT_URI, newsFeedTestValues_set1);
        ...
        newsArticleTestValues_set1.put(NewsContract.NewsArticle.COLUMN_HEADLINE,
                "Arsène Wenger: Arsenal must ‘play with good pace’ to beat Liverpool");
        newsArticleTestValues_set1.put(NewsContract.NewsArticle.COLUMN_IMAGESOURCE_HTML,
        ...
        newsArticleTestValues_set1.put(NewsContract.NewsArticle.COLUMN_ARTICLEIMAGE_URL,
                "http://media.guim.co.uk/e52f4a05ed8b91febd6bc8e4c8a12cf12138888b/0_47_3000_1800/1000.jpg\\");
        newsArticleTestValues_set1.put(NewsContract.NewsArticle.COLUMN_ARTICLEIMAGE, 101010);
        ...
        newsArticleTestValues_set1.put(NewsContract.NewsArticle.COLUMN_BYLINE,
                "Amy Lawrence");

        uri = contentResolver.insert(NewsContract.NewsArticle.CONTENT_URI, newsArticleTestValues_set1);
        ...
        final String articleID_set2 = "uk-news/2015/aug/25/four-britons-die-after-plane-crashes-during-sightseeing-flight-say-reports";
        final Uri newsFeedURI_articleID_set2 = NewsContract.NewsFeed.buildNewsFeedUri(articleID_set2);
        final Uri newsArticleURI_articleID_set2 = NewsContract.NewsArticle.buildNewsArticleUri(articleID_set2);
        ...
        cursor = contentResolver.query(NewsContract.NewsFeed.CONTENT_URI, null, null, null, null);
        assertTrue("Error: Unable to retrieve data from NewsFeedTable", cursor.moveToFirst());
        ...
        newsArticleTestValues_set2.put(NewsContract.NewsArticle.COLUMN_HEADLINE,
                "Four Britons confirmed dead after plane crashes during Quebec sightseeing flight");
        newsArticleTestValues_set2.put(NewsContract.NewsArticle.COLUMN_IMAGESOURCE_HTML,
                "<figure class=\\\"element element-image\\\" data-media-id=\\\"5e6f4b5fd8c28837d948ca3cc05ae4c7ffc2d3d5\\\"> <img src=\\\"http://media.guim.co.uk/5e6f4b5fd8c28837d948ca3cc05ae4c7ffc2d3d5/558_221_2441_1465/1000.jpg\\\" alt=\\\"Plane wreckage\\\" width=\\\"1000\\\" height=\\\"600\\\" class=\\\"gu-image\\\" /> <figcaption> <span class=\\\"element-image__caption\\\">The Air Saguenay plane crashed in dense woodland.</span> <span class=\\\"element-image__credit\\\">Photograph: Transportation Safety Board of Canada/Reuters</span> </figcaption> </figure>");
        newsArticleTestValues_set2.put(NewsContract.NewsArticle.COLUMN_ARTICLEIMAGE_URL,
                "http://media.guim.co.uk/5e6f4b5fd8c28837d948ca3cc05ae4c7ffc2d3d5/558_221_2441_1465/1000.jpg\\");
        newsArticleTestValues_set2.put(NewsContract.NewsArticle.COLUMN_ARTICLEIMAGE, 101010);
        ...
        rowsUpdated = contentResolver.update(NewsContract.NewsArticle.CONTENT_URI,newsArticleTestValues_set2,
        ...
        int rowsDeleted = contentResolver.delete(NewsContract.NewsFeed.CONTENT_URI,null, null);
        ...
        rowsDeleted = contentResolver.delete(NewsContract.NewsArticle.CONTENT_URI,null, null);
        Log.d(TAG, String.valueOf(rowsDeleted));
        ...
        int rowsInserted = contentResolver.bulkInsert(NewsContract.NewsFeed.CONTENT_URI,cvArray);
        ...
        rowsInserted = contentResolver.bulkInsert(NewsContract.NewsArticle.CONTENT_URI,cvArray);
        Log.d(TAG, String.valueOf(rowsInserted));
