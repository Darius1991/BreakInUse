package com.breakinuse.recyclerViewAdapter;
...
import com.breakinuse.NewsArticleActivity;
import com.breakinuse.R;
import com.breakinuse.dataSync.DownloadNewsArticleTask;
            ...
            if ((v == mTextView_headlines) || (v == mTextView_trailText) || (v == mImageView_newsFeedItemImage)){
                ...
                if ((tempCursor != null ) && (tempCursor.moveToFirst())){
                    ...
                    if (tempCursor.moveToPosition(getAdapterPosition())){
                        ...
                        sendIntent.putExtra(Intent.EXTRA_TEXT, "Read this article - " + tempCursor.getString(4));
